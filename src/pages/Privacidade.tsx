...
const Privacidade = () => (
  <div className="min-h-screen bg-background">
    <SEOHead
      title="Política de Privacidade - TwitterDown"
      description="Política de privacidade do TwitterDown. Saiba como tratamos seus dados ao usar nossa ferramenta de download de vídeos do Twitter."
      path="/privacidade"
      breadcrumbs={[{ name: "Início", path: "/" }, { name: "Privacidade", path: "/privacidade" }]}
    />
